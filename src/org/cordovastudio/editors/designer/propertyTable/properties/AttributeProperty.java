 ...
 * (Original as of com.intellij.android.designer.propertyTable.AttributeProperty)
 *
 * Copyright (C) 2014 Christoffer T. Timm
 * Changes:
 *  – Altered equals() Method from using getPath() to comparing getAttributeName()s
 *
...
public class AttributeProperty extends PropertyWithNamespace implements IXmlAttributeLocator {
    ...
    public boolean equals(Object obj) {
        return obj instanceof AttributeProperty && getAttributeName().equals(((AttributeProperty) obj).getAttributeName());
    }
}