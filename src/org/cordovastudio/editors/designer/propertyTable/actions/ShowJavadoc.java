 ...
 *
 * @deprecated JavaDoc shouldn't be needed for Cordova projects, so this class will be removed eventually!
 */
public class ShowJavadoc extends AnAction implements IPropertyTableAction {
  ...
  public ShowJavadoc(RadPropertyTable table) {
    ...
    String text = CordovaDesignerBundle.message("designer.properties.show.javadoc");
