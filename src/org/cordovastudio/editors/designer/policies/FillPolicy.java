 ...
 */
package org.cordovastudio.editors.designer.policies;
...
public enum FillPolicy {
  ...
  /**
   * Returns the {@link org.cordovastudio.editors.designer.policies.ResizePolicy} for the given component
   *
   * @param component the component to look up a resize policy for
   * @return a suitable {@linkplain org.cordovastudio.editors.designer.policies.ResizePolicy}
   */
  @NotNull
  public static FillPolicy getFillPreference(@NotNull RadViewComponent component) {
    ...
    if (paletteItem instanceof CordovaVariationPaletteItem) {
      ...
      FillPolicy preference = item.getFillPolicy();
      if (preference != null) {
        return preference;
      }
    }
