...
public interface RenderContext {
   ...
   */
  @Nullable
  RenderConfiguration getConfiguration();
   ...
   */
  void setConfiguration(@NotNull RenderConfiguration configuration);
  ...
  /**
   * Types of uses of the {@link org.cordovastudio.editors.designer.rendering.RenderService} which can drive some decisions, such as how and whether
