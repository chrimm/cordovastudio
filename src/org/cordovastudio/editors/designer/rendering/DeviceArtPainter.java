...
import static org.cordovastudio.GlobalConstants.DOT_PNG;

/**
 * A device frame painter is capable of directly painting a device frame surrounding
 * a given screen shot rectangle, or creating a new {@link java.awt.image.BufferedImage} where it paints
...
public class DeviceArtPainter {
    ...
    public static BufferedImage createFrame(BufferedImage image, DeviceArtDescriptor descriptor, boolean addShadow, boolean addReflection) {
        ...
        try {
            ...
            if (screen.width < image.getWidth()) {
    ...
    static class FrameData {
        ...
        @NotNull
        private SoftReference<BufferedImage> myPlainImage = new SoftReference<BufferedImage>(null);
        @SuppressWarnings("ConstantConditions")
        @NotNull
        private SoftReference<BufferedImage> myEffectsImage = new SoftReference<BufferedImage>(null);
