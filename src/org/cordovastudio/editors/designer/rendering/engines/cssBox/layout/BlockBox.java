...
public class BlockBox extends ElementBox
{
     ...
     * boxes where the actual parent box obtained using {@link org.cordovastudio.editors.designer.rendering.engines.cssBox.layout.Box#getParent()} is
   ...
   //========================================================================
    ...
    public void computeEfficientMargins()
    {
        ...
        {
            ElementBox firstseparated = null;
            int mbottom = 0;

            for (int i = 0; i < getSubBoxNumber(); i++)
            {
                ElementBox subbox = (ElementBox) getSubBox(i);
