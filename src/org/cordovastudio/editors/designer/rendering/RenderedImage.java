 ...
 * (Original as of com.android.tools.idea.rendering)
 *
 * Copyright (C) 2014 Christoffer T. Timm
 * Changes:
 *  – Removed support for Device frame stretching
 *  – Slight adjustments for Cordova Studio (class names, etc.)
 *
...
public class RenderedImage {
    ...
    public RenderedImage(@NotNull RenderConfiguration configuration,
            ...
            if (myScale <= 1 && myDeviceFrameEnabled) {
                ...
                if (device != null) {
                    PreviewToolWindowSettings.GlobalState settings =
                            PreviewToolWindowSettings.getInstance(myConfiguration.getModule().getProject()).getGlobalState();
    ...
    public int getRequiredWidth() {
        ...
        if (myThumbnailHasFrame || myImageBounds == null && myScaledImage == null && myDeviceFrameEnabled &&
                PreviewToolWindowSettings.getInstance(
    ...
    public void paint(@NotNull Graphics g, int x, int y) {
        ...
        if (myScaledImage == null) {
            ...
            if (myScale == 1) {
                ...
                Device device = myConfiguration.getDevice();
                boolean round = device != null && device.isRound();
