...
public interface PaletteItem {
  ...
  /**
   * @return the creation data to be used by {@link org.cordovastudio.editors.designer.model.MetaModel#getCreation()}
   */
  String getCreation();

  /**
   * Returns the associated {@link org.cordovastudio.editors.designer.model.MetaModel}, if known
   */
  MetaModel getMetaModel();

  /**
   * Sets the associated {@link org.cordovastudio.editors.designer.model.MetaModel}, if known
   */
