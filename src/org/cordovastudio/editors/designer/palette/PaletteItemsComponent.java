...
import org.cordovastudio.editors.designer.componentTree.TreeTransfer;
...
public class PaletteItemsComponent extends JBList {
  ...
  public PaletteItemsComponent(PaletteGroup group, @Nullable CordovaDesignerEditorPanel designer) {
    myGroup = group;
    myDesigner = designer;
