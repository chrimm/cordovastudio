...
public enum Gravity {
  ...
  public static Icon ICON = CordovaIcons.Designer.Gravity;
  ...
  public static int getFlags(RadComponent component) {
    String value = ((RadViewComponent)component).getTag().getAttributeValue("layout_gravity", GlobalConstants.NS_RESOURCES);
    int flags = NONE;
