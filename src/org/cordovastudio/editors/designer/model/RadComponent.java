...
public abstract class RadComponent extends PropertiesContainer {
   ...
   * (see {@link CordovaDesignerEditorPanel#zoom(org.cordovastudio.editors.designer.designSurface.ZoomType)})
   ...
   * the same coordinate system as the bounds returned by {@link #getBounds()}.
   * <p/>
   * Returns a new {@link java.awt.Point}, so callers are free to modify the result.
   *
   ...
   * the same coordinate system as the bounds returned by {@link #getBounds()}.
   * <p/>
   * Returns a new {@link java.awt.Dimension}, so callers are free to modify the result.
   *
   ...
   * @return a corresponding {@link java.awt.Point} in the model coordinate system
   */
  ...
  public void addSelectionActions(CordovaDesignerEditorPanel designer,
  ...
  public String getPropertyValue(String name) {
    if (getProperties() == null) {
        return null;
        //todo: why do we have no properties here? they should be set somewhere...
      /*
