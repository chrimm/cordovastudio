...
import org.cordovastudio.editors.designer.designSurface.operations.GridLayoutOperation;
...
public class RadCaptionGridColumn extends RadCaptionColumn<RadGridLayoutComponent> implements IGroupDeleteComponent {
    public RadCaptionGridColumn(IEditableArea mainArea, RadGridLayoutComponent container, int index, int offset, int width, boolean empty) {
