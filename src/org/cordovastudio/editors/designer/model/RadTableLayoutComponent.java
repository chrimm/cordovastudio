...
public class RadTableLayoutComponent extends RadViewContainer implements IGridProvider {
    ...
    public static int getCellIndex(RadComponent component) {
        try {
            String column = ((RadViewComponent) component).getTag().getAttributeValue("layout_column", NS_RESOURCES);
    ...
    public static int getCellSpan(RadComponent component) {
        try {
            String span = ((RadViewComponent) component).getTag().getAttributeValue("layout_span", NS_RESOURCES);
    ...
    public static void setCellIndex(final RadComponent component, final int column) {
        ApplicationManager.getApplication().runWriteAction(new Runnable() {
            ...
            public void run() {
                ...
                tag.setAttribute("layout_column", NS_RESOURCES, Integer.toString(column));
    ...
    public static void setCellSpan(final RadComponent component, final int span) {
        ApplicationManager.getApplication().runWriteAction(new Runnable() {
            ...
            public void run() {
                XmlTag tag = ((RadViewComponent) component).getTag();
                tag.setAttribute("layout_span", NS_RESOURCES, Integer.toString(span));
            }
        });
    }
}