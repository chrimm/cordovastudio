...
public class ToggleRenderModeAction extends ToggleAction {
  ...
  public ToggleRenderModeAction(@NotNull CordovaDesignerEditorPanel designer) {
    myDesigner = designer;
  ...
  private static void updateIcon(Presentation presentation) {
    presentation.setIcon(ourRenderViewPort ? CordovaIcons.Toolbar.NormalRender : CordovaIcons.Toolbar.ViewportRender);
  }
  ...
  public void setSelected(AnActionEvent e, boolean state) {
    ...
    updateIcon(e.getPresentation());
    ((CordovaDesignerEditorPanel)myDesigner).requestRender();
  }
