...
import org.cordovastudio.editors.designer.clipboard.SimpleTransferable;
...
import org.cordovastudio.editors.designer.designSurface.tools.PasteTool;
import org.cordovastudio.editors.designer.model.IComponentCopyProvider;
import org.cordovastudio.editors.designer.model.IComponentDeletionParticipant;
import org.cordovastudio.editors.designer.model.IGroupDeleteComponent;
...
public class CommonEditActionsProvider implements DeleteProvider, CopyProvider, PasteProvider, CutProvider {
    ...
    public CommonEditActionsProvider(CordovaDesignerEditorPanel designer) {
        myDesigner = designer;
    }

    protected IEditableArea getArea(DataContext dataContext) {
        IEditableArea area = IEditableArea.DATA_KEY.getData(dataContext);
    ...
    public void deleteElement(final @NotNull DataContext dataContext) {
        myDesigner.getToolProvider().execute(new ThrowableRunnable<Exception>() {
            ...
            public void run() throws Exception {
                IEditableArea area = getArea(dataContext);
        ...
        }, CordovaDesignerBundle.message("command.delete.selection"), true);
    }
    ...
    public static void updateSelectionBeforeDelete(IEditableArea area, RadComponent component, List<RadComponent> excludes) {
        try {
            isDeleting = true;
