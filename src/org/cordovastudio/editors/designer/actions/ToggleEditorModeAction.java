...
public class ToggleEditorModeAction extends ToggleAction {
  ...
  private AbstractToolWindowManager getOppositeManager() {
    AbstractToolWindowManager designerManager = CordovaDesignerToolWindowManager.getInstance(myProject);
    AbstractToolWindowManager paletteManager = CordovaPaletteToolWindowManager.getInstance(myProject);
