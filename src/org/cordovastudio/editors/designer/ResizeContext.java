...
public class ResizeContext {
   ...
   */
  public ResizeContext(IEditableArea area, RadViewComponent layout, @Nullable Object layoutView, RadViewComponent node) {
    myArea = area;
    this.layout = layout;
    this.node = node;
  ...
  protected void initializeSnapBounds() {
    ...
    String width = node.getAttribute(ATTR_LAYOUT_WIDTH, NS_RESOURCES);
    String height = node.getAttribute(ATTR_LAYOUT_HEIGHT, NS_RESOURCES);
