...
import org.cordovastudio.editors.designer.actions.DesignerActionPanel;
import org.cordovastudio.editors.designer.actions.StartInplaceEditing;
...
public final class ComponentTree extends Tree implements DataProvider {
  ...
  public void setDesignerPanel(@Nullable CordovaDesignerEditorPanel designer) {
    myDesigner = designer;
  ...
  public Object getData(@NonNls String dataId) {
    if (IEditableArea.DATA_KEY.is(dataId)) {
      return myArea;
    }
    if (myDesigner != null) {
