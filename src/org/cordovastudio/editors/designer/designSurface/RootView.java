...
import org.cordovastudio.editors.designer.rendering.Overlay;
...
/**
 * Root component used for the Cordova designer.
 */
public class RootView extends JComponent implements TransformedComponent {
  ...
  public RootView(@NotNull CordovaDesignerEditorPanel panel, int x, int y, @NotNull RenderResult renderResult) {
    myX = x;
    myY = y;
    myPanel = panel;
  ...
  @NotNull
  public CordovaDesignerEditorPanel getPanel() {
    return myPanel;
  }
