...
class BinPacker {
     ...
     * initial available space rectangles with {@link #addSpace(java.awt.Rectangle)}, and then
     * place the rectangles with {@link #occupy(int, int)}. The returned
     * {@link java.awt.Rectangle} from {@link #occupy(int, int)} gives the coordinates of the
     ...
     * {@link java.util.ArrayList}, removing a rectangle in the normal way is slow (it
