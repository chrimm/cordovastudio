...
import org.cordovastudio.editors.designer.designSurface.ZoomProvider;
...
public abstract class ToolProvider implements ZoomProvider {
  ...
  public void processKeyEvent(KeyEvent event, IEditableArea area) {
    if (myTool != null) {
      try {
        switch (event.getID()) {
  ...
  public void processMouseEvent(MouseEvent event, IEditableArea area) {
    if (myTool != null) {
      try {
        switch (event.getID()) {
  ...
  public void setArea(@Nullable IEditableArea area) {
    myArea = area;
  }
