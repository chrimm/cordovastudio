 ...
 */
package org.cordovastudio.editors.designer.designSurface.tools;
...
public abstract class InputTool {
  ...
  protected IEditableArea myArea;
  ...
  public final void setArea(@Nullable IEditableArea area) {
    if (myArea != area) {
      setCursor(null);
      myArea = area;
  ...
  public void keyTyped(KeyEvent event, IEditableArea area) throws Exception {
    setEvent(event);
    setArea(area);
  }

  public void keyPressed(KeyEvent event, IEditableArea area) throws Exception {
    setEvent(event);
    setArea(area);
  }

  public void keyReleased(KeyEvent event, IEditableArea area) throws Exception {
    setEvent(event);
    setArea(area);
  }
  ...
  public void mouseDown(MouseEvent event, IEditableArea area) throws Exception {
    setArea(area);
    setEvent(event);
  ...
  public void mouseDrag(MouseEvent event, IEditableArea area) throws Exception {
    setArea(area);
  ...
  public void mousePopup(MouseEvent event, IEditableArea area) throws Exception {
    setArea(area);
    setEvent(event);
    handlePopup();
  }

  public void mouseDoubleClick(MouseEvent event, IEditableArea area) throws Exception {
    setArea(area);
    setEvent(event);
