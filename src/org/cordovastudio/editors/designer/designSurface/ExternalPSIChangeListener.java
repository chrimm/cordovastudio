 ...
 * (Original as of
 *  com.intellij.designer.designSurface.ExternalPSIChangeListener
 *  and
 *  com.intellij.android.designer.designSurface.ExternalPSIChangeListener)
 *
 * Copyright (C) 2014 Christoffer T. Timm
 * Changes:
 *  – Merged both abovementioned classes
 *
...
public class ExternalPSIChangeListener extends PsiTreeChangeAdapter {
    ...
    protected final CordovaDesignerEditorPanel myDesigner;
    ...
    public ExternalPSIChangeListener(CordovaDesignerEditorPanel designer, PsiFile file, int delayMillis, Runnable runnable) {
        myDesigner = designer;
        myFile = file;
    ...
    public void deactivate() {
        ...
        if (!myDesigner.isProjectClosed()) {
            CordovaFacet facet = CordovaFacet.getInstance(myDesigner.getModule());
        }
    }
