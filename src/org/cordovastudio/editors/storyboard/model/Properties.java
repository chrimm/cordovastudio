...
import org.cordovastudio.annotations.Transient;
...
public class Properties {
    ...
    public abstract static class Property<T> {
        ...
        public abstract Object getValue(T o) throws PropertyAccessException;
    }
    ...
    static class FieldProperty<T> extends Property<T> {
        ...
        @Override
        public Object getValue(T o) throws PropertyAccessException {
            try {
                return field.get(o);
    ...
    */
    ...
    public static Property[] computeProperties(Class c) {
