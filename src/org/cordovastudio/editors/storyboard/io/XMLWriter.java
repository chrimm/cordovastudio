 ...
 */
package org.cordovastudio.editors.storyboard.io;

import org.cordovastudio.editors.storyboard.model.Properties;
import org.cordovastudio.editors.storyboard.model.Utilities;
...
public class XMLWriter {
    ...
    class ClassAttribute extends Attribute<Class> {
         ...
         * the value of the "state" property of a {@link org.cordovastudio.editors.storyboard.model.Transition}. If the property is "get/setState()" we needn't record
    ...
    private NameValue traverse(@NotNull Class type, String name, Object value, boolean isTopLevel) {
        if (isPrimitive(type)) {
