...
public class BuildSettings {
  private static final Key<BuildMode> PROJECT_BUILD_MODE_KEY = Key.create("cordovastudio.project.build.mode");
  private static final Key<Module[]> SELECTED_MODULE_NAMES_KEY = Key.create("cordovastudio.project.selected.module.names");
  private static final Key<String> RUN_CONFIGURATION_TYPE_ID = Key.create("cordovastudio.project.run.configuration.type.id");
