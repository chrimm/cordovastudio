 ...
 * (Original as of com.android.tools.idea.configurations.FlatComboAction)
 *
 * Copyright (C) 2014 Christoffer T. Timm
 * Changes:
 *  – Icons adjusted for Cordova Studio
 *
...
public abstract class FlatComboAction extends AnAction implements CustomComponentAction {
  private static final Icon ARROW_DOWN = CordovaIcons.Toolbar.DropDownArrow;
