 ...
 */
public class ActionRemover extends AnAction {
    @NotNull protected final AnAction myDelegate;


    /**
     * Creates a new {@link ActionRemover}.
     *
     * @param delegate the action to hide/remove.
     * @param backupText the text to set in this action, in case the the delegate action does not have any text yet.
     */
    public ActionRemover(@NotNull AnAction delegate, @NotNull String backupText) {
        ...
        if ("".equals(presentation.getText())) {
