...
/**
 * Wraps an {@link java.io.InputStream} to change its closing behavior:
 * this makes it possible to ignore close operations or have them perform a
 * {@link java.io.InputStream#reset()} instead (if supported by the underlying stream)
 * or plain ignored.
 * <p/>
...
public class NonClosingInputStream extends FilterInputStream {
    ...
    public enum CloseBehavior {
         ...
         * {@link java.io.InputStream#reset()} on the underlying stream. This will
         * only succeed if the underlying stream supports it, e.g. it must
         * have {@link java.io.InputStream#markSupported()} return true <em>and</em>
         * the caller should have called {@link java.io.InputStream#mark(int)} at some
         * point before.
         */
        RESET
    }
     ...
     */
    public NonClosingInputStream(@NotNull InputStream in) {
        super(in);
        mInputStream = in;
    }
     ...
     */
    public NonClosingInputStream setCloseBehavior(@NotNull CloseBehavior closeBehavior) {
