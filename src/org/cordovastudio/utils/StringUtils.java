...
import static org.cordovastudio.GlobalConstants.DOT_XML;
...
public class StringUtils {
    ...
    /**
     * Returns the corresponding {@link java.io.File} for the given file:// url
     *
     * @param url the URL string, e.g. file://foo/bar
     * @return the corresponding {@link java.io.File} (which may or may not exist)
     * @throws java.net.MalformedURLException if the URL string is malformed or is not a file: URL
     */
    @NotNull
    ...
    /**
     * Returns the corresponding URL string for the given {@link java.io.File}
     *
     * @param file the file to look up the URL for
     * @return the corresponding URL
     * @throws java.net.MalformedURLException in very unexpected cases
     */
    ...
    /**
     * Returns the corresponding URL for the given {@link java.io.File}
     *
     * @param file the file to look up the URL for
     * @return the corresponding URL
     * @throws java.net.MalformedURLException in very unexpected cases
